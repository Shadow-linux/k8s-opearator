...
//+kubebuilder:webhook:path=/mutate-myapp-shadow-com-v1-redis,mutating=true,failurePolicy=fail,sideEffects=None,groups=myapp.shadow.com,resources=redis,verbs=create;update,versions=v1,name=mredis.kb.io,admissionReviewVersions=v1
